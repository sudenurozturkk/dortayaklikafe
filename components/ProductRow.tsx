...
export default function ProductRow({ item }: { item: MenuItem }) {
  return (
    <motion.div
      ...
      className="group flex flex-col items-start gap-2 sm:gap-3 p-3 sm:p-4 rounded-lg border-2 border-basalt-700 bg-basalt-900/60"
    >
      ...
      <div className="w-full sm:text-right flex justify-start sm:justify-end items-start">
