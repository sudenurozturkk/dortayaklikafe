        ...
        <div className="relative">
          <div className="flex items-center gap-4 mb-5">
            <div className="relative">
              ...
              <div className="relative p-4 bg-gradient-to-br from-copper-600 to-terracotta-600 rounded-xl border-2 border-copper-700 shadow-copper wood-texture">
                <Icon className="w-8 h-8 text-basalt-50" />
              </div>
            </div>
            <div className="flex-1">
              <h3 className="font-ottoman font-black text-2xl text-basalt-900 group-hover:text-copper-700 transition-colors tracking-wide">
                {title}
              </h3>
              <p className="text-sm text-basalt-500 mt-1 font-semibold tracking-wide">Menüyü Keşfet</p>
            </div>
          </div>
