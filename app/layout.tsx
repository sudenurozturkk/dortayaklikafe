  ...
  return (
    <html lang="tr">
      <body>
            ...
            <div className="h-24 flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className="relative group">
                  ...
                  <div className="relative bg-gradient-to-br from-copper-600 via-copper-500 to-terracotta-600 p-4 rounded-lg shadow-copper border-2 border-copper-700 wood-texture wood-grain">
                    <Coffee className="text-basalt-50 w-7 h-7" />
                  </div>
                </div>
                <div>
                  <p className="font-ottoman font-black text-2xl text-transparent bg-clip-text bg-gradient-to-r from-copper-400 via-copper-300 to-terracotta-400 tracking-wider drop-shadow-lg">
                    DÖRT AYAKLI
                  </p>
                  <p className="text-xs text-basalt-300 font-semibold flex items-center gap-1.5 tracking-widest uppercase mt-0.5">
        ...
        <main className="container py-10 min-h-[calc(100vh-280px)]">
          {children}
        </main>
        ...
        <footer className="relative border-t-4 border-basalt-700 mt-20 bg-gradient-to-b from-basalt-800 to-basalt-900 diyarbakir-pattern wall-pattern">
          ...
          <div className="container py-12">
            <div className="flex flex-col items-center gap-5">
              <div className="flex items-center gap-4">
                <div className="p-3 bg-gradient-to-br from-copper-600 to-terracotta-600 rounded-lg shadow-copper wood-texture wood-grain">
                  <Coffee className="text-basalt-50 w-6 h-6" />
                </div>
                <span className="font-ottoman font-black text-2xl text-transparent bg-clip-text bg-gradient-to-r from-copper-400 to-terracotta-400 tracking-wider">
                  DÖRT AYAKLI
                </span>
              </div>
              <p className="text-basalt-300 text-sm text-center max-w-md leading-relaxed">
                Diyarbakır'ın tarihi dokusunu ve bazalt avlusunun<br/>otantik ruhunu sofranıza taşıyoruz
              </p>
              <div className="h-0.5 w-40 bg-gradient-to-r from-transparent via-copper-500 to-transparent"></div>
              <p className="text-basalt-400 text-xs tracking-wider">
